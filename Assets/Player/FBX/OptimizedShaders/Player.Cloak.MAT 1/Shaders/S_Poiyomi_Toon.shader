Shader "Hidden/.poiyomi/• Poiyomi Toon •/Player.Cloak.MAT 1-Player.Cloak.MAT 1"
{
    Properties
    {
...
#define _DETAILSOURCE_SPECULARALPHA
#define _ENABLETRIPLANARPROJECTION_ON
#define _SMOOTHNESS_TEXTURE_ALBEDO_CHANNEL_A
#define _SOURCE_SPECULARALPHA
#define _TRIPLANARSPACEPROJECTION_OBJECTSPACE
#define _USEAOFROMMAINPROPERTIES_ON
#define _USEEMISSIONFROMMAINPROPERTIES_ON
